...
def run_cuj(page):
    ...
    page.screenshot(path="/home/jules/verification/screenshots/inventory_icons4.png")
    page.wait_for_timeout(1000)
    ...
    page.screenshot(path="/home/jules/verification/screenshots/world_caves4.png")
    page.wait_for_timeout(1000)
