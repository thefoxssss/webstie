...
def run_cuj(page):
    ...
    # Directly force the room join by calling the specific builderJoinRoom endpoint
    page.evaluate('''
        if (typeof window.builderJoinRoom === 'function') {
            window.builderJoinRoom(null); // Passing null often triggers "create new" or "quick join" in colyseus setups.
        } else {
    ...
    page.screenshot(path="/home/jules/verification/screenshots/inventory_icons11.png")
    page.wait_for_timeout(1000)
    ...
    page.screenshot(path="/home/jules/verification/screenshots/world_caves11.png")
    page.wait_for_timeout(1000)
