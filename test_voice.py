...
def run_cuj(page):
    ...
    page.screenshot(path="/home/jules/verification/screenshots/voice_lobby.png")
    page.wait_for_timeout(1000)
    ...
    # Take screenshot of menu after leaving
    page.screenshot(path="/home/jules/verification/screenshots/voice_menu_after.png")
    page.wait_for_timeout(1000)
    ...
    try:
        with sync_playwright() as p:
            ...
            context = browser.new_context(
                ...
                permissions=['microphone'] # Voice lounge needs mic permission
            )
