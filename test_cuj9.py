...
def run_cuj(page):
    ...
    page.evaluate('''
        if (window.builderJoinRoom) {
            window.builderJoinRoom("Public World"); // Or just null to trigger create/join
        }
    ''')
    ...
    page.screenshot(path="/home/jules/verification/screenshots/inventory_icons9.png")
    page.wait_for_timeout(1000)
    ...
    page.screenshot(path="/home/jules/verification/screenshots/world_caves9.png")
    page.wait_for_timeout(1000)
