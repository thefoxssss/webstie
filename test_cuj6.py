...
def run_cuj(page):
    ...
    page.evaluate('''
        if (window.room) {
           ...
           // Emulate a click on whatever the quick join button is, or the first button in #builderMenu
           const btn = document.querySelector('#builderMenu button.arcade-btn');
           if(btn) btn.click();
        }
    ''')
    ...
    page.screenshot(path="/home/jules/verification/screenshots/inventory_icons6.png")
    page.wait_for_timeout(1000)
    ...
    page.screenshot(path="/home/jules/verification/screenshots/world_caves6.png")
    page.wait_for_timeout(1000)
