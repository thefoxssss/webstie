...
def run_cuj(page):
    ...
    # Click the quick join button using get_by_role
    page.get_by_role("button", name="QUICK JOIN ANY SERVER").click()
    page.wait_for_timeout(4000)

    # In builder, open inventory to show the item icons
    page.keyboard.press("e")
    page.wait_for_timeout(1000)
    page.screenshot(path="/home/jules/verification/screenshots/inventory_icons10.png")
    page.wait_for_timeout(1000)
    ...
    page.screenshot(path="/home/jules/verification/screenshots/world_caves10.png")
    page.wait_for_timeout(1000)
